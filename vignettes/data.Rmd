...
<a href="http://reichlab.io/forecast-framework-demos/#defining-inputs-incidence-matrix-1"><button type="button" class="btn btn-raised btn-secondary">Proceed to Defining the Inputs</button></a>